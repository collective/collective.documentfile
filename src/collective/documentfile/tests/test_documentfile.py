...
from collective.documentfile.interfaces import IDocumentFile
...
class DocumentFileIntegrationTest(unittest.TestCase):
    ...
    def test_factory(self):
        ...
        self.assertTrue(IDocumentFile.providedBy(obj))

    def test_adding(self):
        self.portal.invokeFactory('DocumentFile', 'DocumentFile')
        self.assertTrue(
            IDocumentFile.providedBy(self.portal['DocumentFile'])
        )
